...
public class Computer : MonoBehaviour
{
    ...
    public float minX = 7f; // Limite mínimo de x
    public float maxX = 8f; // Limite máximo de x
    ...
    void Update()
    {
        ...
        var targetY = Mathf.Lerp(transform.position.y, ballPosition.y, 0.2f); // Ajusta a suavidade da previsão
        var targetX = Mathf.Lerp(transform.position.x, ballPosition.x, 0.2f); // Ajusta a suavidade da previsão
